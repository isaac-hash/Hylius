...
This guide will help you get hylius TypeScript up and running and pushed to GitHub.
...
git branch -M main
git remote add origin https://github.com/isaac-hash/hylius.git
git push -u origin main
```

### 4. Install Globally (Optional)

To use `hylius` command anywhere on your system:
...
If you want others to install via `npm install -g hylius`:

```bash
# Login to npm
npm login

# Publish (make sure to update package name if 'hylius' is taken)
npm publish
```
